...
data = pd.read_csv("C:/Users/raghu/FalseAWSKeyDataset.csv")
TRAIN_FILE = data.Data
TRAIN_LABS = data.Label
...
if __name__ == '__main__':
	...
	print(hist.history)
## Since the data is not sufficient to train this model, the model is left behind